...
describe('Calculator', function() {
  ...
  it('should return 0.008539325842696628 for 76 / 89', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('percent').click(); 
    expect(document.querySelector('.display').value).toBe('0.008539325842696628');
  });
  ...
  it('should return -28.35 for 0 - 2 + 0 / 34 * 43344 - 2833', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('percent').click(); 
    expect(document.querySelector('.display').value).toBe('-28.35');
  });
  ...
  it('should return 0.05 for 2 + 3', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('percent').click(); 
    expect(document.querySelector('.display').value).toBe('0.05');
  });
  ...
  it('should return 0.27 for 12 + 15', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('percent').click(); 
    expect(document.querySelector('.display').value).toBe('0.27');
  });
  ...
  it('should return 0.012469878581533821 for 65 * 1234 / 0000064323', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('percent').click(); 
    expect(document.querySelector('.display').value).toBe('0.012469878581533821');
  });
