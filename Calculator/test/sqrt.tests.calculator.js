...
describe('Calculator', function() {
  ...
  it('should return 0.9240847278630152 for 76 / 89', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('sqrt').click(); 
    expect(document.querySelector('.display').value).toBe('0.9240847278630152');
  });
  ...
  it('should return 2.23606797749979 for 2 + 3', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('sqrt').click(); 
    expect(document.querySelector('.display').value).toBe('2.23606797749979');
  });
  ...
  it('should return 5.196152422706632 for 12 + 15', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('sqrt').click(); 
    expect(document.querySelector('.display').value).toBe('5.196152422706632');
  });
  ...
  it('should return 1.1166861054716237 for 65 * 1234 / 0000064323', function() {
    ...
    document.getElementById('btn=').click(); 
    document.getElementById('sqrt').click(); 
    expect(document.querySelector('.display').value).toBe('1.1166861054716237');
  });
